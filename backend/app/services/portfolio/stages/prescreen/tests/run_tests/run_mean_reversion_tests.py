...
def run_mean_reversion_tests(short_start, long_start, long_data, filters):
    """
    ...
    if not autocorrelation_test(long_data, short_start, long_start, filters["autocorrelation"]):
        return False
